...
{
    /// <inheritdoc />
    public partial class RemoveRoleFromAllocation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Allocations_Periods_PeriodId",
                        column: x => x.PeriodId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Allocations_ResourceId_ProjectId_PeriodId",
                table: "Allocations",
                columns: new[] { "ResourceId", "ProjectId", "PeriodId" },
                unique: true);
